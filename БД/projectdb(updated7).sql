...
INSERT INTO `грамоты` VALUES (1,'За профессионализм в обучении ИТ-технологиям','Pictures\\Certificates\\cert1.png',2),(2,'Выдающийся преподаватель ИТ-дисциплин','Pictures\\Certificates\\cert2.png',2),(3,'За отличный вклад в развитие ИТ-образования','Pictures\\Certificates\\cert3.png',2),(4,'За высокий уровень преподавания ИТ-курсов','Pictures\\Certificates\\cert4.png',4),(5,'Сертификат','Pictures\\Certificates\\cert5.png',4);
...
CREATE TABLE `материалы` (
  `Код_Материала` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `материалы` VALUES (1,1,1,4,1,1,1,1,1,1,1,1),(2,1,2,2,1,1,1,0,1,1,0,1),(3,1,10,6,1,1,1,1,1,1,0,0),(4,1,7,4,1,1,1,1,1,1,1,1),(5,1,11,8,0,1,1,1,1,1,1,1),(6,1,13,3,0,1,1,1,1,1,1,1),(7,1,12,7,1,1,1,1,1,1,1,1),(8,1,8,7,1,1,1,1,1,1,1,1),(9,1,3,2,1,1,1,1,1,1,0,1),(10,1,4,2,1,1,1,0,1,1,0,1),(11,1,5,2,1,1,1,1,1,1,0,1),(12,1,6,5,1,1,1,1,1,1,0,0),(13,1,9,4,1,1,1,1,1,1,0,1),(14,2,14,2,1,1,1,1,1,1,1,1),(15,2,15,2,1,1,1,1,1,1,1,1),(16,2,16,2,1,1,1,1,1,1,1,1);
...
INSERT INTO `подразделение` VALUES (1,'Программирование в компьютерных системах',7,7),(2,'Цикловая комиссия',1,2);
...
INSERT INTO `преподаватели` VALUES (1,'Не работает',NULL,NULL,'',NULL,NULL,NULL,NULL),(2,'Николаева В. С.','1990-09-09',1,'Pictures\\Teachers\\person1.jpg','2 года','Разработка программного обеспечения','+7 (926) 123-45-67','m.kowalski5241@example.com'),(3,'Губанова К. М.','1999-01-01',1,'Pictures\\Teachers\\person2.png','4 года','Базы данных и управление данными','+7 (965) 789-01-23','s.petrov3698@example.com'),(4,'Крылова В. С.','1999-02-01',1,'Pictures\\Teachers\\person3.png','1 год','Сетевые технологии и безопасность','+7 (495) 234-56-78','a.smith2376@example.com'),(5,'Никитина С. К.','1999-02-01',1,'Pictures\\Teachers\\person4.png','5 лет','Веб-разработка и дизайн','+7 (929) 876-54-32','j.doe9463@example.com'),(6,'Антонова М. В.','1999-02-01',1,'Pictures\\Teachers\\person5.png','9 лет','Облачные технологии и виртуализация','+7 (916) 345-67-89','n.brown6829@example.com'),(7,'Смирнова М. М.','1999-02-01',1,'Pictures\\Teachers\\person6.png','10 лет','Веб-разработка и дизайн','+7 (926) 890-12-34','k.lee4512@example.com'),(8,'Николаева Э. Р.','1999-02-01',1,'Pictures\\Teachers\\person7.png','11 месяцев','Базы данных и управление данными','+7 (495) 567-89-01','d.jackson1834@example.com');
...
CREATE TABLE `специальности` (
  ...
  KEY `Код_подразделения_idx` (`Код_подразделения`),
  CONSTRAINT `Код_подразделения` FOREIGN KEY (`Код_подразделения`) REFERENCES `подразделение` (`Код_подразделения`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `специальности` VALUES (1,'09.02.07 Информационные системы и программирование',1),(2,'09.02.01 Компьютерные системы и комплексы',1),(3,'Общепрофессиональные дисциплины специальностей',1),(4,'Общеобразовательный цикл',1),(5,'специальность 5',2),(6,'специальность 6',2),(7,'специальность 7',2);
...
-- Dump completed on 2023-05-27 21:59:51

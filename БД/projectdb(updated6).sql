...
INSERT INTO `подразделение` VALUES (1,'Программирование в компьютерных системах',7,1);
...
INSERT INTO `специальности` VALUES (1,'09.02.07 Информационные системы и программирование',1),(2,'09.02.01 Компьютерные системы и комплексы',1),(3,'Общепрофессиональные дисциплины специальностей',1),(4,'Общеобразовательный цикл',1);
...
-- Dump completed on 2023-05-25 21:50:29

...
INSERT INTO `подразделение` VALUES (1,'09.02.07 Информационные системы и программирование',2,1),(2,'09.02.01 Компьютерные системы и комплексы',0,1);
...
INSERT INTO `предметы` VALUES (1,'ОП.04'),(2,'ОП.08'),(3,'ОП.10'),(4,'ПМ.01'),(5,'ПМ.02'),(6,'ПМ.03');
...
-- Dump completed on 2023-02-10  1:21:38

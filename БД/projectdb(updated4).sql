...
INSERT INTO `пользователи` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','Начальник мет. отдела'),(2,'user','20838a8df7cc0babd745c7af4b7d94e2','Методист'),(3,'bd','bc0cf9b0e1380dcb03a629a2e4f31069','Администратор БД'),(4,'Sadmin','16ec37c499f64fc60e95650b500e30a4','Администратор'),(5,'admin','ccd35b07f034a925be35534dca54b6d5','Администратор'),(6,'dsfsd','adved','safdf');
...
INSERT INTO `преподаватели` VALUES (1,'Не работает',NULL,NULL,''),(2,'Гунько И.А.','1990-09-09',1,'person1.jpg'),(3,'Галкина Н.Г.','1999-01-01',1,'person2.png'),(4,'Блохина Т.В.','1999-02-01',1,'person3.png'),(5,'Нецветаева А.Е.','1999-02-01',1,'person4.png'),(6,'Кульбацкая Л.В.','1999-02-01',1,'person5.png'),(7,'Порубайко Т.А.','1999-02-01',1,'person6.png'),(8,'Кострица Н.В.','1999-02-01',1,'person7.png');
...
-- Dump completed on 2023-04-13 16:29:13
